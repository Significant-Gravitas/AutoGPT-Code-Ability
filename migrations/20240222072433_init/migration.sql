...
-- AddForeignKey
ALTER TABLE "CodeGraph" ADD CONSTRAINT "CodeGraph_parentCodeGraphId_fkey" FOREIGN KEY ("parentCodeGraphId") REFERENCES "CodeGraph"("id") ON DELETE CASCADE ON UPDATE CASCADE;
