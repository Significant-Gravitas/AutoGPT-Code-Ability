...
from codex.requirements.model import DatabaseSchema, EndpointSchemaRefinementResponse
...
def is_valid_type(
    ...
    typing_types = ["List", "Dict", "Tuple", "Set", "Any", "Optional"]
    default_types = ["int", "float", "str", "bool", "None"]
...
if __name__ == "__main__":
    ...
    # Assuming you have a list of enum names and table names
    db_models = ["User", "Appointment", "Invoice", "Payment", "Notification"]
        ...
        Fields=[
            ...
            ObjectFieldModel(
                ...
                related_types=[
                    ObjectTypeModel(
                        name="NestedType",
                        description="A nested type for testing.",
                        Fields=[
                            ObjectFieldModel(
                                name="double_nest",
                                description="The type of the access token provided. Typically 'Bearer'.",
                                type="DoubleNested[str]",
                                related_types=[
                                    ObjectTypeModel(
                                        name="DoubleNested",
                                        description="A double nested type for testing.",
                                        Fields=[
                                            ObjectFieldModel(
                                                name="type",
                                                description="The type of the access token provided. Typically 'Bearer'.",
    ...
    response_model = ObjectTypeModel(
        ...
        Fields=[
            ...
            ObjectFieldModel(
                name="access_token",
                description="A secure token that the user can use for accessing authenticated parts of the application.",
                type="dict[str, any]",
                related_types=[],
            ),
            ObjectFieldModel(
                ...
                related_types=[
                    ObjectTypeModel(
                        name="Tree",
                        code=None,
                        description="A tree structure representing the token type.",
                        Fields=[
                            ObjectFieldModel(
                                name="type",
                                description="The type of the access token provided. Typically 'Bearer'.",
    ...
    # Assuming you have an ObjectTypeModel instance named 'object_model'
    (
        request_types,
        response_types,
        request_object_types,
    ...
    print(f"Response Model: {new_response_model.model_dump_json()}")
...
#     from codex.requirements.model import DatabaseEnums, DatabaseSchema, DatabaseTable
